...
! function(a) {
    a.fn.cxScroll = function(b) {
        ...
        this.length && (b = a.extend({}, a.cxScroll.defaults, b), c = this, d = {
            ...
            if (d.dom.box = c.find(".box"), d.dom.list = d.dom.box.find(".slist"), d.dom.items = d.dom.list.find("li"), d.itemSum = d.dom.items.length, d.dom.list.append(d.dom.list.html()), !(d.itemSum <= 1)) {
