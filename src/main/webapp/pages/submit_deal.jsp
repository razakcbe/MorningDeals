...
<select name="categoryId" id="categoryId" tabindex="5" class="cmbselect">
                                    ...
                                    <optgroup label="Women">
                                            <option value="10023">Clothing</option>
                                            <option value="10024">Footwear</option>
                                            <option value="10025">Watches</option>
                                            <option value="10026">Jewellery</option>
                                            <option value="10027">Bags, Belts & Wallets</option>
                                            <option value="10028">Contact Lenses</option>
                                            <option value="10029">Sunglasses</option>
                                            <option value="10030">Spectacle Frames</option>
                                            <option value="10031">Beauty & Personal Care</option>
                                            <option value="10032">Perfumes</option>
                                            <option value="10033">Wellness</option>                                    </optgroup>                                 

                                    <optgroup label="Baby Products">
                                            <option value="10034">Clothing</option>
                                            <option value="10035">Footwear</option>
                                            <option value="10036">Toys</option>
                                            <option value="10037">Baby Care</option>
                                            <option value="10038">School Supplies</option>
                                            <option value="10039">Kids Sports</option>
                                            <option value="10040">Watches</option>
                                            <option value="10041">Books</option>
                                            <option value="10042">Movies</option>
                                            <option value="10043">Sunglasses</option>
                                    </optgroup>                                 

                                    <optgroup label="Home Products">
                                            <option value="10044">Kitchen & Dining</option>
                                            <option value="10045">Home Furnishing</option>
                                            <option value="10046">Home Appliances</option>
                                            <option value="10047">Kitchen Appliances</option>
                                            <option value="10048">Furniture</option>
                                            <option value="10049">Tools & Hardware</option>
                                            <option value="10050">Home Specials</option>
                                            <option value="10051">Bath Essential</option>
                                            <option value="10052">Household Supplies</option>
                                            <option value="10053">Housekeeping & Laundry</option>
                                            <option value="10054">Pet Supplies</option>
                                     </optgroup>                                 

                                    <optgroup label="Book & Media">
                                            <option value="10055">Books</option>
                                            <option value="10056">eLearning</option>
                                            <option value="10057">eBooks & ePrints</option>
                                            <option value="10058">Music</option>
                                            <option value="10059">Movies & TV Shows</option>
                                            <option value="10060">Gaming</option>
                                            <option value="10061">Stationary</option>
                                            <option value="10062">Office Equipments</option>
											<option value="10063">Exam Supplies</option>
                                    </optgroup>                                 

                                    <optgroup label="Sports">
											<option value="10064">Sports Clothing</option>
											<option value="10065">Sports Footwear</option>
											<option value="10066">Fitness & BodyBuilding</option>
											<option value="10067">Cardio Equipments</option>
											<option value="10068">Sports</option>
											<option value="10069">Outdoors</option>                                    </optgroup>                                 

                                    <optgroup label="Bike & Car Spares">
											<option value="10070">Car Essentials</option>
											<option value="10071">Bike Essentials</option>
											<option value="10072">Car Electronics</option>
											<option value="10073">Tyres</option>
											<option value="10074">Lighting</option>
											<option value="10075">Styling</option>
											<option value="10076">Spares & Equipment</option>
											<option value="10077">Lubricants & Oils</option>
											<option value="10078">Helmets & Protective Wear</option>
											<option value="10079">Vehicle Covers</option>
											<option value="10080">Washing & Cleaning</option>
											<option value="10081">Breakdown Equipment</option>
											<option value="10082">Car Freshness</option>
                                    </optgroup>                                 
   </select>
